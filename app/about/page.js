...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8">
            <h1 className="text-3xl font-semibold mb-4">About Get Me A Momo</h1>
            <p className="text-gray-300 mb-6">
                Get Me A Momo is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It&apos;s a space where your fans can directly contribute to your creative endeavors by buying you a momo. Unlock the potential of your fanbase and bring your projects to life.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="/coin.gif" alt="Support Through Momo" />
                    <div>
                        <h3 className="text-xl font-semibold mb-2">Support Through Momo</h3>
                        <p>Receive support from your fans in the form of momo purchases, directly contributing to your project funding.</p>
                    </div>
                </div>
